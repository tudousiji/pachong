...
updateFailProxyIp='http://mytaobaoke/index.php/api/Proxyip/updateFailProxyIp';#更新失败代理ip
getNextProxyIpList='http://mytaobaoke/index.php/api/Proxyip/getNextProxyIpList?page={0}'
